...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>重启使配置生效<br><code>git config -l --global</code></p><p>查看当前代理<br><code>git config -l</code></p>`,8),d=[l];function o(c,a){return e(),s("div",null,d)}const p=i(t,[["render",o],["__file","100-git-config-proxy.html.vue"]]);export{p as default};
