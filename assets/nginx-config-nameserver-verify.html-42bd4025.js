import{_ as n,X as e,Y as s,a1 as a}from"./framework-ca96282b.js";const i={},l=a(`<h1 id="nginx配置严格域名校验" tabindex="-1"><a class="header-anchor" href="#nginx配置严格域名校验" aria-hidden="true">#</a> Nginx配置严格域名校验</h1><p>如禁止IP直接访问</p><p>default_server</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code>server <span class="token punctuation">{</span>
