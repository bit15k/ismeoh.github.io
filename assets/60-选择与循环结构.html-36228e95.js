import{_ as n,W as e,X as a,a0 as s}from"./framework-0a321081.js";const i={},d=s(`<h1 id="选择与循环结构" tabindex="-1"><a class="header-anchor" href="#选择与循环结构" aria-hidden="true">#</a> 选择与循环结构</h1><h2 id="选择结构" tabindex="-1"><a class="header-anchor" href="#选择结构" aria-hidden="true">#</a> 选择结构</h2><p>选择结构的实现主要有if语句和switch语句</p><h3 id="if语句" tabindex="-1"><a class="header-anchor" href="#if语句" aria-hidden="true">#</a> if语句</h3><p>基本格式</p><div class="language-C line-numbers-mode" data-ext="C"><pre class="language-C"><code>if()
    ...
else if()
