import{_ as e,W as i,X as n,a0 as d}from"./framework-0a321081.js";const a={},s=d(`<h2 id="创建备份数据库存放处" tabindex="-1"><a class="header-anchor" href="#创建备份数据库存放处" aria-hidden="true">#</a> 创建备份数据库存放处</h2><div class="language-xml line-numbers-mode" data-ext="xml"><pre class="language-xml"><code>mkdir -p /backup/data
