import{_ as e,X as i,Y as n,a0 as d}from"./framework-44854a8b.js";const a={},s=d(`<h2 id="创建备份数据库存放处" tabindex="-1"><a class="header-anchor" href="#创建备份数据库存放处" aria-hidden="true">#</a> 创建备份数据库存放处</h2><div class="language-xml line-numbers-mode" data-ext="xml"><pre class="language-xml"><code>mkdir -p /backup/data
