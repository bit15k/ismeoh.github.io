import{_ as n,W as s,X as a,a0 as e}from"./framework-0a321081.js";const t={},p=e(`<h1 id="线性表" tabindex="-1"><a class="header-anchor" href="#线性表" aria-hidden="true">#</a> 线性表</h1><h2 id="算法" tabindex="-1"><a class="header-anchor" href="#算法" aria-hidden="true">#</a> 算法</h2><h3 id="插入算法" tabindex="-1"><a class="header-anchor" href="#插入算法" aria-hidden="true">#</a> 插入算法</h3><p><img src="https://cdn.jsdelivr.net/gh/ismeoh/imgchr//imgs/线性表-2023-02-22-22-48-22.png" alt="线性表-2023-02-22-22-48-22"></p><p>代码实现</p><div class="language-c line-numbers-mode" data-ext="c"><pre class="language-c"><code><span class="token comment">/**
 * @brief 插入元素到线性表某个位置
 * @param l 线性表引用
 * @param i 位置
 * @param e 元素
